...
from CommonEnvironment.YamlStr import *
...
class BasicWithClassInfoAndCustomDisplay(ObjectStrImplBase):
    A: int
    B: bool
    C: str
...
# ----------------------------------------------------------------------
@dataclass(frozen=True)
class Simple(ObjectStrImplBase):
    A: int
    B: bool
    C: Optional[str]
...
# ----------------------------------------------------------------------
@dataclass(frozen=True)
class Complex(ObjectStrImplBase):
    Simple: Simple
...
class TestStandard(object):
    ...
    def test_Str(self):
        assert str(self._object) == textwrap.dedent(
            """\
            # <class 'CommonEnvironment.UnitTests.YamlStr_UnitTest.Complex'>
            ATuple:
              - 1
              - 2
            EmptyDict: {}
            ...
            Obj: # <class 'CommonEnvironment.UnitTests.YamlStr_UnitTest.BasicWithClassInfoAndCustomDisplay'>
              A: 1 # <class 'int'>
              C: "**A**"
            Simple: # <class 'CommonEnvironment.UnitTests.YamlStr_UnitTest.Simple'>
              A: 1
              B: true
              C: "A"
              S: null
            Simples:
              - # <class 'CommonEnvironment.UnitTests.YamlStr_UnitTest.Simple'>
                A: 100
                B: true
                C: "a string"
                S: null
              ...
              - # <class 'CommonEnvironment.UnitTests.YamlStr_UnitTest.Simple'>
                ...
                B: false
                C: null
                S: # <class 'CommonEnvironment.UnitTests.YamlStr_UnitTest.Simple'>
                  A: 400000
                  B: true
                  C: |-
                    An embedded object
    ...
    def test_MaxRecursionDepth(self):
        assert self._object.ToYamlString(
            ...
            Simple: # <class 'CommonEnvironment.UnitTests.YamlStr_UnitTest.Simple'>
              ...
              S: null
            Simples:
              - "-- recursion is disabled: complex element '<class 'CommonEnvironment.UnitTests.YamlStr_UnitTest.Simple'>' --"
              - "-- recursion is disabled: complex element '<class 'CommonEnvironment.UnitTests.YamlStr_UnitTest.Simple'>' --"
              - "-- recursion is disabled: complex element '<class 'CommonEnvironment.UnitTests.YamlStr_UnitTest.Simple'>' --"
              - "-- recursion is disabled: complex element '<class 'CommonEnvironment.UnitTests.YamlStr_UnitTest.Simple'>' --"
              - "-- recursion is disabled: complex element '<class 'CommonEnvironment.UnitTests.YamlStr_UnitTest.Simple'>' --"
