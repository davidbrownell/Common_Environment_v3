...
# |  Generated on: 2020-12-31 14:56:54.332017
# |
# --------------------------------------------------------------------------------
import copy
import sys
...
locations_TypeInfo                                                          = AnyOfTypeInfo([ClassTypeInfo(_locations_TypeInfo_Contents, require_exact_match=False), DictTypeInfo(_locations_TypeInfo_Contents, require_exact_match=False)], arity=Arity.FromString('*'))
locations_location_name_TypeInfo                                            = StringTypeInfo(min_length=1)
locations_configurations_TypeInfo                                           = AnyOfTypeInfo([ClassTypeInfo(_locations_configurations_TypeInfo_Contents, require_exact_match=False), DictTypeInfo(_locations_configurations_TypeInfo_Contents, require_exact_match=False)], arity=Arity.FromString('+'))
locations_configurations_configuration_name_TypeInfo                        = StringTypeInfo(min_length=1)
locations_configurations_executables_TypeInfo                               = AnyOfTypeInfo([ClassTypeInfo(_locations_configurations_executables_TypeInfo_Contents, require_exact_match=False), DictTypeInfo(_locations_configurations_executables_TypeInfo_Contents, require_exact_match=False)], arity=Arity.FromString('+'))
locations_configurations_executables_executable_name_TypeInfo               = StringTypeInfo(min_length=1)
locations_configurations_executables_values_TypeInfo                        = AnyOfTypeInfo([ClassTypeInfo(_locations_configurations_executables_values_TypeInfo_Contents, require_exact_match=False), DictTypeInfo(_locations_configurations_executables_values_TypeInfo_Contents, require_exact_match=False)], arity=Arity.FromString('+'))
locations_configurations_executables_values_Name_TypeInfo                   = StringTypeInfo(min_length=1)
locations_configurations_executables_values_Extractor_TypeInfo              = StringTypeInfo(min_length=1)
locations_configurations_executables_values_SourceFilename_TypeInfo         = StringTypeInfo(min_length=1)
locations_configurations_executables_values_SourceLine_TypeInfo             = IntTypeInfo(min=1)
locations_configurations_executables_values_Min_TypeInfo                    = FloatTypeInfo(min=0.0)
locations_configurations_executables_values_Max_TypeInfo                    = FloatTypeInfo(min=0.0)
locations_configurations_executables_values_Mean_TypeInfo                   = FloatTypeInfo(min=0.0)
locations_configurations_executables_values_StandardDeviation_TypeInfo      = FloatTypeInfo(min=0.0)
locations_configurations_executables_values_Samples_TypeInfo                = IntTypeInfo(min=1)
locations_configurations_executables_values_Units_TypeInfo                  = StringTypeInfo(min_length=1)
locations_configurations_executables_values_Iterations_TypeInfo             = IntTypeInfo(min=1)
...
class Serializer(object):
    ...
    def locations(cls, item, always_include_optional, process_additional_data):
        if item in [DoesNotExist, None, {}, OrderedDict]:
            locations_TypeInfo.ValidateArity(None)
            return DoesNotExist

        if not process_additional_data:
            locations_TypeInfo.ValidateArity(item)
    ...
    def locations_location_name(cls, item):
        if item in [DoesNotExist, None]:
            locations_location_name_TypeInfo.ValidateArity(None)
            return DoesNotExist

        locations_location_name_TypeInfo.ValidateArity(item)
    ...
    def locations_configurations(cls, item, always_include_optional, process_additional_data):
        if item in [DoesNotExist, None, {}, OrderedDict]:
            locations_configurations_TypeInfo.ValidateArity(None)
            return DoesNotExist

        if not process_additional_data:
            locations_configurations_TypeInfo.ValidateArity(item)
    ...
    def locations_configurations_configuration_name(cls, item):
        if item in [DoesNotExist, None]:
            locations_configurations_configuration_name_TypeInfo.ValidateArity(None)
            return DoesNotExist

        locations_configurations_configuration_name_TypeInfo.ValidateArity(item)
    ...
    def locations_configurations_executables(cls, item, always_include_optional, process_additional_data):
        if item in [DoesNotExist, None, {}, OrderedDict]:
            locations_configurations_executables_TypeInfo.ValidateArity(None)
            return DoesNotExist

        if not process_additional_data:
            locations_configurations_executables_TypeInfo.ValidateArity(item)
    ...
    def locations_configurations_executables_executable_name(cls, item):
        if item in [DoesNotExist, None]:
            locations_configurations_executables_executable_name_TypeInfo.ValidateArity(None)
            return DoesNotExist

        locations_configurations_executables_executable_name_TypeInfo.ValidateArity(item)
    ...
    def locations_configurations_executables_values(cls, items, always_include_optional, process_additional_data):
        if items in [DoesNotExist, None, []]:
            locations_configurations_executables_values_TypeInfo.ValidateArity(None)
            return DoesNotExist

        if not process_additional_data:
            locations_configurations_executables_values_TypeInfo.ValidateArity(items)
    ...
    def locations_configurations_executables_values_Name(cls, item):
        if item in [DoesNotExist, None]:
            locations_configurations_executables_values_Name_TypeInfo.ValidateArity(None)
            return DoesNotExist

        locations_configurations_executables_values_Name_TypeInfo.ValidateArity(item)
    ...
    def locations_configurations_executables_values_Extractor(cls, item):
        if item in [DoesNotExist, None]:
            locations_configurations_executables_values_Extractor_TypeInfo.ValidateArity(None)
            return DoesNotExist

        locations_configurations_executables_values_Extractor_TypeInfo.ValidateArity(item)
    ...
    def locations_configurations_executables_values_SourceFilename(cls, item):
        if item in [DoesNotExist, None]:
            locations_configurations_executables_values_SourceFilename_TypeInfo.ValidateArity(None)
            return DoesNotExist

        locations_configurations_executables_values_SourceFilename_TypeInfo.ValidateArity(item)
    ...
    def locations_configurations_executables_values_SourceLine(cls, item):
        if item in [DoesNotExist, None]:
            locations_configurations_executables_values_SourceLine_TypeInfo.ValidateArity(None)
            return DoesNotExist

        locations_configurations_executables_values_SourceLine_TypeInfo.ValidateArity(item)
    ...
    def locations_configurations_executables_values_Min(cls, item):
        if item in [DoesNotExist, None]:
            locations_configurations_executables_values_Min_TypeInfo.ValidateArity(None)
            return DoesNotExist

        locations_configurations_executables_values_Min_TypeInfo.ValidateArity(item)
    ...
    def locations_configurations_executables_values_Max(cls, item):
        if item in [DoesNotExist, None]:
            locations_configurations_executables_values_Max_TypeInfo.ValidateArity(None)
            return DoesNotExist

        locations_configurations_executables_values_Max_TypeInfo.ValidateArity(item)
    ...
    def locations_configurations_executables_values_Mean(cls, item):
        if item in [DoesNotExist, None]:
            locations_configurations_executables_values_Mean_TypeInfo.ValidateArity(None)
            return DoesNotExist

        locations_configurations_executables_values_Mean_TypeInfo.ValidateArity(item)
    ...
    def locations_configurations_executables_values_StandardDeviation(cls, item):
        if item in [DoesNotExist, None]:
            locations_configurations_executables_values_StandardDeviation_TypeInfo.ValidateArity(None)
            return DoesNotExist

        locations_configurations_executables_values_StandardDeviation_TypeInfo.ValidateArity(item)
    ...
    def locations_configurations_executables_values_Samples(cls, item):
        if item in [DoesNotExist, None]:
            locations_configurations_executables_values_Samples_TypeInfo.ValidateArity(None)
            return DoesNotExist

        locations_configurations_executables_values_Samples_TypeInfo.ValidateArity(item)
    ...
    def locations_configurations_executables_values_Units(cls, item):
        if item in [DoesNotExist, None]:
            locations_configurations_executables_values_Units_TypeInfo.ValidateArity(None)
            return DoesNotExist

        locations_configurations_executables_values_Units_TypeInfo.ValidateArity(item)
    ...
    def locations_configurations_executables_values_Iterations(cls, item):
        if item in [DoesNotExist, None]:
            locations_configurations_executables_values_Iterations_TypeInfo.ValidateArity(None)
            return DoesNotExist

        locations_configurations_executables_values_Iterations_TypeInfo.ValidateArity(item)
    ...
    def _locations_location_name_Item(cls, item):
        return JsonSerialization.SerializeItem(locations_location_name_TypeInfo, item, **{})
    ...
    def _locations_configurations_configuration_name_Item(cls, item):
        return JsonSerialization.SerializeItem(locations_configurations_configuration_name_TypeInfo, item, **{})
    ...
    def _locations_configurations_executables_executable_name_Item(cls, item):
        return JsonSerialization.SerializeItem(locations_configurations_executables_executable_name_TypeInfo, item, **{})

    # ----------------------------------------------------------------------
    @classmethod
    def _locations_configurations_executables_values_Item(cls, item, always_include_optional, process_additional_data):
        locations_configurations_executables_values_TypeInfo.ValidateItem(
            item,
            recurse=False,
    ...
    def _locations_configurations_executables_values_Name_Item(cls, item):
        return JsonSerialization.SerializeItem(locations_configurations_executables_values_Name_TypeInfo, item, **{})

    # ----------------------------------------------------------------------
    @classmethod
    def _locations_configurations_executables_values_Extractor_Item(cls, item):
        return JsonSerialization.SerializeItem(locations_configurations_executables_values_Extractor_TypeInfo, item, **{})

    # ----------------------------------------------------------------------
    @classmethod
    def _locations_configurations_executables_values_SourceFilename_Item(cls, item):
        return JsonSerialization.SerializeItem(locations_configurations_executables_values_SourceFilename_TypeInfo, item, **{})

    # ----------------------------------------------------------------------
    @classmethod
    def _locations_configurations_executables_values_SourceLine_Item(cls, item):
        return JsonSerialization.SerializeItem(locations_configurations_executables_values_SourceLine_TypeInfo, item, **{})

    # ----------------------------------------------------------------------
    @classmethod
    def _locations_configurations_executables_values_Min_Item(cls, item):
        return JsonSerialization.SerializeItem(locations_configurations_executables_values_Min_TypeInfo, item, **{})

    # ----------------------------------------------------------------------
    @classmethod
    def _locations_configurations_executables_values_Max_Item(cls, item):
        return JsonSerialization.SerializeItem(locations_configurations_executables_values_Max_TypeInfo, item, **{})

    # ----------------------------------------------------------------------
    @classmethod
    def _locations_configurations_executables_values_Mean_Item(cls, item):
        return JsonSerialization.SerializeItem(locations_configurations_executables_values_Mean_TypeInfo, item, **{})

    # ----------------------------------------------------------------------
    @classmethod
    def _locations_configurations_executables_values_StandardDeviation_Item(cls, item):
        return JsonSerialization.SerializeItem(locations_configurations_executables_values_StandardDeviation_TypeInfo, item, **{})

    # ----------------------------------------------------------------------
    @classmethod
    def _locations_configurations_executables_values_Samples_Item(cls, item):
        return JsonSerialization.SerializeItem(locations_configurations_executables_values_Samples_TypeInfo, item, **{})

    # ----------------------------------------------------------------------
    @classmethod
    def _locations_configurations_executables_values_Units_Item(cls, item):
        return JsonSerialization.SerializeItem(locations_configurations_executables_values_Units_TypeInfo, item, **{})

    # ----------------------------------------------------------------------
    @classmethod
    def _locations_configurations_executables_values_Iterations_Item(cls, item):
        return JsonSerialization.SerializeItem(locations_configurations_executables_values_Iterations_TypeInfo, item, **{})
...
class Deserializer(object):
    ...
    def locations(cls, item, always_include_optional, process_additional_data):
        ...
        if not process_additional_data:
            locations_TypeInfo.ValidateArity(result)
    ...
    def locations_location_name(cls, item):
        ...
        locations_location_name_TypeInfo.ValidateArity(result)
    ...
    def locations_configurations(cls, item, always_include_optional, process_additional_data):
        ...
        if not process_additional_data:
            locations_configurations_TypeInfo.ValidateArity(result)
    ...
    def locations_configurations_configuration_name(cls, item):
        ...
        locations_configurations_configuration_name_TypeInfo.ValidateArity(result)
    ...
    def locations_configurations_executables(cls, item, always_include_optional, process_additional_data):
        ...
        if not process_additional_data:
            locations_configurations_executables_TypeInfo.ValidateArity(result)
    ...
    def locations_configurations_executables_executable_name(cls, item):
        ...
        locations_configurations_executables_executable_name_TypeInfo.ValidateArity(result)
    ...
    def locations_configurations_executables_values(cls, items, always_include_optional, process_additional_data):
        ...
        if not process_additional_data:
            locations_configurations_executables_values_TypeInfo.ValidateArity(results)
    ...
    def locations_configurations_executables_values_Name(cls, item):
        ...
        locations_configurations_executables_values_Name_TypeInfo.ValidateArity(result)
    ...
    def locations_configurations_executables_values_Extractor(cls, item):
        ...
        locations_configurations_executables_values_Extractor_TypeInfo.ValidateArity(result)
    ...
    def locations_configurations_executables_values_SourceFilename(cls, item):
        ...
        locations_configurations_executables_values_SourceFilename_TypeInfo.ValidateArity(result)
    ...
    def locations_configurations_executables_values_SourceLine(cls, item):
        ...
        locations_configurations_executables_values_SourceLine_TypeInfo.ValidateArity(result)
    ...
    def locations_configurations_executables_values_Min(cls, item):
        ...
        locations_configurations_executables_values_Min_TypeInfo.ValidateArity(result)
    ...
    def locations_configurations_executables_values_Max(cls, item):
        ...
        locations_configurations_executables_values_Max_TypeInfo.ValidateArity(result)
    ...
    def locations_configurations_executables_values_Mean(cls, item):
        ...
        locations_configurations_executables_values_Mean_TypeInfo.ValidateArity(result)
    ...
    def locations_configurations_executables_values_StandardDeviation(cls, item):
        ...
        locations_configurations_executables_values_StandardDeviation_TypeInfo.ValidateArity(result)
    ...
    def locations_configurations_executables_values_Samples(cls, item):
        ...
        locations_configurations_executables_values_Samples_TypeInfo.ValidateArity(result)
    ...
    def locations_configurations_executables_values_Units(cls, item):
        ...
        locations_configurations_executables_values_Units_TypeInfo.ValidateArity(result)
    ...
    def locations_configurations_executables_values_Iterations(cls, item):
        ...
        locations_configurations_executables_values_Iterations_TypeInfo.ValidateArity(result)
    ...
    @classmethod
    def _locations_location_name_Item(cls, item):
        return JsonSerialization.DeserializeItem(locations_location_name_TypeInfo, item, **{})
    ...
    @classmethod
    def _locations_configurations_configuration_name_Item(cls, item):
        return JsonSerialization.DeserializeItem(locations_configurations_configuration_name_TypeInfo, item, **{})
    ...
    @classmethod
    def _locations_configurations_executables_executable_name_Item(cls, item):
        return JsonSerialization.DeserializeItem(locations_configurations_executables_executable_name_TypeInfo, item, **{})
    ...
    @classmethod
    def _locations_configurations_executables_values_Name_Item(cls, item):
        return JsonSerialization.DeserializeItem(locations_configurations_executables_values_Name_TypeInfo, item, **{})

    # ----------------------------------------------------------------------
    @classmethod
    def _locations_configurations_executables_values_Extractor_Item(cls, item):
        return JsonSerialization.DeserializeItem(locations_configurations_executables_values_Extractor_TypeInfo, item, **{})

    # ----------------------------------------------------------------------
    @classmethod
    def _locations_configurations_executables_values_SourceFilename_Item(cls, item):
        return JsonSerialization.DeserializeItem(locations_configurations_executables_values_SourceFilename_TypeInfo, item, **{})

    # ----------------------------------------------------------------------
    @classmethod
    def _locations_configurations_executables_values_SourceLine_Item(cls, item):
        return JsonSerialization.DeserializeItem(locations_configurations_executables_values_SourceLine_TypeInfo, item, **{})

    # ----------------------------------------------------------------------
    @classmethod
    def _locations_configurations_executables_values_Min_Item(cls, item):
        return JsonSerialization.DeserializeItem(locations_configurations_executables_values_Min_TypeInfo, item, **{})

    # ----------------------------------------------------------------------
    @classmethod
    def _locations_configurations_executables_values_Max_Item(cls, item):
        return JsonSerialization.DeserializeItem(locations_configurations_executables_values_Max_TypeInfo, item, **{})

    # ----------------------------------------------------------------------
    @classmethod
    def _locations_configurations_executables_values_Mean_Item(cls, item):
        return JsonSerialization.DeserializeItem(locations_configurations_executables_values_Mean_TypeInfo, item, **{})

    # ----------------------------------------------------------------------
    @classmethod
    def _locations_configurations_executables_values_StandardDeviation_Item(cls, item):
        return JsonSerialization.DeserializeItem(locations_configurations_executables_values_StandardDeviation_TypeInfo, item, **{})

    # ----------------------------------------------------------------------
    @classmethod
    def _locations_configurations_executables_values_Samples_Item(cls, item):
        return JsonSerialization.DeserializeItem(locations_configurations_executables_values_Samples_TypeInfo, item, **{})

    # ----------------------------------------------------------------------
    @classmethod
    def _locations_configurations_executables_values_Units_Item(cls, item):
        return JsonSerialization.DeserializeItem(locations_configurations_executables_values_Units_TypeInfo, item, **{})

    # ----------------------------------------------------------------------
    @classmethod
    def _locations_configurations_executables_values_Iterations_Item(cls, item):
        return JsonSerialization.DeserializeItem(locations_configurations_executables_values_Iterations_TypeInfo, item, **{})
