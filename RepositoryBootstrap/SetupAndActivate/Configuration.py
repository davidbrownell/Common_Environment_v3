...
class Configuration(object):
    ...
    def __init__( self,
                  ...
                  dependencies=None,
                  version_specs=None,
                  ignore_library_conflicts=None,
                ):
        # `ignore_library_conflicts` is a list of names of libraries that have conflicts that can be safely ignored.
        ...
        self.IgnoreLibraryConflicts         = ignore_library_conflicts
