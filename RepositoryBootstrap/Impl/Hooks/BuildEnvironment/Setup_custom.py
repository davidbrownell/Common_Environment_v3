...
def GetDependencies():
    ...
    return Configuration(
        ...
        [
            Dependency(
                "5C7E1B3369B74BC098141FAD290288DA",                           # Id for Common_Environment; found in <Common_Environment>/__RepositoryId__
                "Common_SimpleSchemaGenerator",                               # Name used if Common_Environment cannot be found during setup
                None,                                                         # Configuration value used when activating Common_Environment (can be None or skipped for repos that only support a single configuration)
                "https://github.com/davidbrownell/Common_SimpleSchemaGenerator.git", # Uri for repo; can be string or def Func(scm_or_none) -> string
            ),
